...
def select_device(device='', batch_size=None):
    ...
    # return torch.device('cuda:{}'.format(device[0]) if cuda else 'cpu')
...
def profile(x, ops, n=100, device=None):
    # profile a pytorch model or list of modules. Example usage:
...
def find_modules(model, mclass=nn.Conv2d):
    # Finds layer indices matching model class 'mclass'
